  ...
  return (
    <div className="relative flex min-h-screen flex-col">
      ...
      <div className="flex min-h-0 flex-1">
        <main className="relative flex min-h-0 min-w-0 flex-1 flex-col bg-background/40">
          <AnimatedOutlet />
        </main>
      </div>
      {!isAdminArea ? (
        <footer className="relative border-t border-border bg-card/60 py-5 pb-[max(1.25rem,env(safe-area-inset-bottom))] text-center text-xs text-muted-foreground shadow-[0_-12px_40px_-18px_rgba(0,0,0,0.45)] backdrop-blur-xl sm:py-6">
